...
// 喉嚨＋根部＋直覺＋情緒 → 深棕色（C.coffee）／薦骨＋意志力（心）→ 橘色（C.terracotta）
const CENTERS = {
  ...
  '喉': { fill: C.coffee, shape: 'rect', x: 385.0, y: 254.0, w: 130.0, h: 118.0 },
  ...
  '直覺': { fill: C.coffee, shape: 'poly', pts: [[300.5, 633.4], [170.5, 551.4], [170.5, 715.4]] },
  '情緒': { fill: C.coffee, shape: 'poly', pts: [[599.5, 633.4], [729.5, 551.4], [729.5, 715.4]] },
  '薦骨': { fill: C.terracotta, shape: 'rect', x: 385.0, y: 601.6, w: 130.0, h: 118.0 },
  '根': { fill: C.coffee, shape: 'rect', x: 385.0, y: 747.0, w: 130.0, h: 118.0 },
};
